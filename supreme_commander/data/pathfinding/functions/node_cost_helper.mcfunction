##
# node_cost_helper.mcfunction
# Author: Micheal Kerr
# Summary: helper function for node_cost.mcfunction; updates the cost of nodes
##
...
execute as @e[tag=start] at @s run function pathfinding:node_cost
