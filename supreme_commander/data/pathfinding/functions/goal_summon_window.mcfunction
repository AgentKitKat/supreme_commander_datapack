...
# summon a new goal on each unblocked section (summons a helper armor stand that travels forward on each side of the square)
...
execute as @e[tag=goal2] run scoreboard players reset @s trapped
