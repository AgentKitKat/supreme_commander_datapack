...
execute align xz positioned ~.5 ~ ~1.5 unless score @e[limit=1,distance=0,tag=node] open matches 0 as @e[limit=1,distance=0,tag=node] at @s run function dijkstra:point_to
execute align xz positioned ~.5 ~ ~-.5 unless score @e[limit=1,distance=0,tag=node] open matches 0 as @e[limit=1,distance=0,tag=node] at @s run function dijkstra:point_to
execute align xz positioned ~1.5 ~ ~.5 unless score @e[limit=1,distance=0,tag=node] open matches 0 as @e[limit=1,distance=0,tag=node] at @s run function dijkstra:point_to
execute align xz positioned ~-.5 ~ ~.5 unless score @e[limit=1,distance=0,tag=node] open matches 0 as @e[limit=1,distance=0,tag=node] at @s run function dijkstra:point_to